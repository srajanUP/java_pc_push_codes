...
public class DefaultMethodInInterface {
    public static void main(String[] args) {
        ...
        //checking the instansiation of the the object
        System.out.println(ms instanceof MySmartphone); //true
        System.out.println(ms instanceof MyCellPhone);  //true 
        System.out.println(ms instanceof Object);       //true  
        System.out.println(ms instanceof camera);       //true
        System.out.println(ms instanceof wifi);         //true
    }
