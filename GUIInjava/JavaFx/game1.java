...
public class game1 extends Application {
    ...
    PointView player = new PointView(new Point2D(500, 500));
    PointView enemy = new PointView(new Point2D(500,500));
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        scene.setOnMouseClicked(event -> {
            ...
            TranslateTransition tt = new TranslateTransition(Duration.seconds(1.7), bullet);
